...
public class ActivityLevel2 extends FragmentActivity implements OnTouchListener {
	// STUBVIEW
	...
	// DEVICE....
	RelativeLayout rl;
	// Arraylist for puzzle GETTING IT FROM THE METHOD GETPUZZLE IN JParserInLevel2
	// CLASS/USED IN PARSE() METHOD...
	ArrayList<puzzle1> game2;
...
//	final int count = 3;
	...
	final String KEY_VAL_PREFIX_HINT_2_2_ = "VAL_HINT_2_2_";
	final String KEY_VAL_PREFIX_HINT_2_1_ = "VAL_HINT_2_1_";
	int textColor=Color.rgb(228, 174, 107);
	int random;
	int randomEntered;
	SharedPreferences app_preferences_random,app_preferences_coins,app_preferences_trick_cat_level2;
...
//		bpointsHeader=(Button)findViewById(R.id.bpointsHeader);
//		bpointsHeader.setBackgroundResource(R.drawable.points10);
	...
	private void parse() {
		// TODO Auto-generated method stub
		game2 = new ArrayList<puzzle1>();
		game2.clear();
		InputStream inputStream = getResources().openRawResource(
				R.raw.puzzlespellapic);
		...
		JParserInLevel2 parsedData = new JParserInLevel2();
		game2 = parsedData.getPuzzle(byteArrayOutputStream);
	}
...
//			numbersHintLine2.clear();
		...
		protected void onPostExecute(Void result) {
			...
			values.clear();
			app_preferences_random = getSharedPreferences("apps_random_2",
					MODE_PRIVATE);
	...
	protected void onPause() {
		// TODO Auto-generated method stub
		super.onPause();
		app_preferences_trick_cat_level2 = getSharedPreferences("appsPreferenceTrickHint", MODE_PRIVATE);
		Editor sped = app_preferences_trick_cat_level2.edit();
		for(int i=0;i<numbersHintLine1.size();i++){
			System.out.println("boldit,,,,,,,,////22222");
		sped.putInt(KEY_VAL_PREFIX_HINT_2_1_ +i, numbersHintLine1.get(i));
		}
		sped.putInt("sizeHint2_1", numbersHintLine1.size());
		for(int i=0;i<numbersHintLine2.size();i++){
			System.out.println("boldit,,,,,,,,////22222");
		sped.putInt(KEY_VAL_PREFIX_HINT_2_2_ +i, numbersHintLine2.get(i));
		}
		sped.putInt("sizeHint2_2", numbersHintLine2.size());
		sped.commit();
		numbersHintLine1.clear();
		numbersHintLine2.clear();
	}
...
//		noOfHintLine1.clear();
		...
		app_preferences_trick_cat_level2 = getSharedPreferences("appsPreferenceTrickHint",
				MODE_PRIVATE);
		int size1 = app_preferences_trick_cat_level2.getInt("sizeHint2_1", 0);
		if (size1 > 0) {
...
//						+ j, 0));
				noOfHintLine1.add(app_preferences_trick_cat_level2.getInt(KEY_VAL_PREFIX_HINT_2_1_
						+ j, 0));
...
//						+ j, 0));
		...
		int size2 = app_preferences_trick_cat_level2.getInt("sizeHint2_2", 0);
		if (size2 > 0) {
			System.out.println("boldit,,,,,,,,////5555");
			for (int j = 0; j < size2; j++) {
				noOfHintLine2.add(app_preferences_trick_cat_level2.getInt(KEY_VAL_PREFIX_HINT_2_2_
						+ j, 0));
			}
	...
	private void trickHint(int i) {
		app_preferences_trick_cat_level2 = getSharedPreferences("appsPreferenceTrickHint", MODE_PRIVATE);
		SharedPreferences.Editor editorSharing = app_preferences_trick_cat_level2.edit();
		editorSharing.putInt("KEY_HINT_CAT_2_", i);
	...
	private void initialRandomPuzzle() {
		// TODO Auto-generated method stub
		// pp = new puzzle1();
		if (values.size() < game2.size()) {
			randomizeBegin();
		} else if(values.size()==game2.size()){
	...
	private void sharing() {
		app_preferences_coins = getSharedPreferences("appsPreferenceCoins", MODE_PRIVATE);
	...
	private void initialize() {
		...
		sharing();
		app_preferences1 = getSharedPreferences("apps1", MODE_PRIVATE);
		noOfCoins = app_preferences1.getInt("KEY_COINS", 500);
...
//		keyboardLine3.addView(b_KB_abc);
	...
	b_KB_abc.setOnTouchListener(new View.OnTouchListener() {

		@Override
		public boolean onTouch(View arg0, MotionEvent event) {
			
			if (event.getAction() == MotionEvent.ACTION_DOWN && arg0==b_KB_abc) {
	...
	b_KB_cat.setOnTouchListener(new View.OnTouchListener() {

		@Override
		public boolean onTouch(View arg0, MotionEvent event) {

			app_preferences_trick_cat_level2 = getSharedPreferences(
					"appsPreferenceTrickHint", MODE_PRIVATE);
			int no = app_preferences_trick_cat_level2.getInt(
					"KEY_HINT_CAT_2_", 1);
...
private void InfoThemeAlert(String string, String string2) {
	...
	final Dialog dialogAlert = new Dialog(ActivityLevel2.this,R.style.CustomDialogTheme);
	...
	System.out.println("iiiiiaminiiiiiiii222222222");
	 dialogAlert.getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,WindowManager.LayoutParams.FLAG_FULLSCREEN);
	 Button image1 = (Button) dialogAlert.findViewById(R.id.image1);
		Button image2 = (Button) dialogAlert.findViewById(R.id.image2);
		Button imageCancel = (Button) dialogAlert.findViewById(R.id.imageCancel);
...
//		LinearLayout.LayoutParams imageFinishParams = new LinearLayout.LayoutParams(
//				width, width);
...
//		initialize();
	...
	private void beginthegame(int random2) {
		...
		app_preferences_random = getSharedPreferences("apps_random_2", MODE_PRIVATE);
		Editor sped = app_preferences_random.edit();
		sped.putInt("randomentered", help);
		sped.commit();  
		pp = game2.get(randomEntered);
				...
				try {
					...
					if (preWordArray1.size() != 0) {
						...
						for (int prewordarray1 = 0; prewordarray1 < preWordArray1
							...
							editor1[lenStart].setTypeface(Typeface.SERIF, 2);
					...
					if(numbersHintLine1.size()>0){
						...
						for(int k=0;k<numbersHintLine1.size();k++){
							...
							editor1[numbersHintLine1.get(k)].setTextColor(Color.GREEN);
							editor1[numbersHintLine1.get(k)].setText(spaceAnswer1.charAt(noOfHintLine1.get(k))+"");
				...
				try {
					...
					if(numbersHintLine2.size()>0){
						...
						for(int k=0;k<numbersHintLine2.size();k++){
							...
							editor2[numbersHintLine2.get(k)].setTextColor(Color.GREEN);
							editor2[numbersHintLine2.get(k)].setText(spaceAnswer2.charAt(noOfHintLine2.get(k))+"");
...
//				Toast.makeText(ActivityLevel2.this, "Wrong Answer",
...
//				bpointsHeader.setVisibility(View.GONE);
				pp=null;
				HintEarnings(-10);
				initialRandomPuzzle();
			}
	...
	private void showBaby() {
		...
		if (audio == 1) {
			mpCoin1 = MediaPlayer.create(ActivityLevel2.this, R.raw.coin_sound);
			mpCoin2 = MediaPlayer.create(ActivityLevel2.this, R.raw.coin_sound);
			mpCoin3 = MediaPlayer.create(ActivityLevel2.this, R.raw.coin_sound);
			mpCoin4 = MediaPlayer.create(ActivityLevel2.this, R.raw.coin_sound);
			mpCoin5 = MediaPlayer.create(ActivityLevel2.this, R.raw.coin_sound);
		}
		...
		bpointSuperpb.setBackgroundResource(R.drawable.points10);
		rotation = AnimationUtils.loadAnimation(this,
				R.anim.cook);
		// rotation.setRepeatCount(5);
		points = AnimationUtils.loadAnimation(this,
				R.anim.points);
	...
	private void imaging(int i) {
		...
		if (i == 1) {
			...
			iv1.setBackgroundResource(this.getResources().getIdentifier(
					"img_2_2_" + puzzle_id + "_1", "drawable", getPackageName()));
			...
			iv1.setTag("img_2_2_" + puzzle_id + "_1");
			iv1.setLayoutParams(imageParams);
			tr1.addView(iv1);
		} else if (i == 2) {
			iv1 = new ImageView(this);
			iv1.setBackgroundResource(this.getResources().getIdentifier(
					"img_2_" + puzzle_id + "_1", "drawable", getPackageName()));
			iv2 = new ImageView(this);
			iv2.setBackgroundResource(this.getResources().getIdentifier(
					"img_2_" + puzzle_id + "_2", "drawable", getPackageName()));
			TableRow.LayoutParams imageParams = new TableRow.LayoutParams();
			...
			iv1.setTag("img_2_" + puzzle_id + "_1");
			iv2.setTag("img_2_" + puzzle_id + "_2");
			iv1.setLayoutParams(imageParams);
			...
			iv3.setBackgroundResource(this.getResources().getIdentifier(
					"img_2_" + puzzle_id + "_3", "drawable", getPackageName()));
			TableRow.LayoutParams imageParams = new TableRow.LayoutParams();
			...
			iv1.setTag("img_2_" + puzzle_id + "_1");
			iv2.setTag("img_2_" + puzzle_id + "_2");
			iv3.setTag("img_2_" + puzzle_id + "_3");
			iv1.setLayoutParams(imageParams);
			iv2.setLayoutParams(imageParams);
			...
			iv4.setBackgroundResource(this.getResources().getIdentifier(
					"img_2_" + puzzle_id + "_4", "drawable", getPackageName()));
			TableRow.LayoutParams imageParams = new TableRow.LayoutParams();
			...
			iv2.setTag("img_2_" + puzzle_id + "_2");
			iv3.setTag("img_2_" + puzzle_id + "_3");
			iv4.setTag("img_2_" + puzzle_id + "_4");
			iv1.setLayoutParams(imageParams);
			iv2.setLayoutParams(imageParams);
			iv3.setLayoutParams(imageParams);
			...
			iv5.setBackgroundResource(this.getResources().getIdentifier(
					"img_2_" + puzzle_id + "_5", "drawable", getPackageName()));
			TableRow.LayoutParams imageParams = new TableRow.LayoutParams();
			imageParams.height = width / 3;
			imageParams.width = width / 3 - 15;
			imageParams.topMargin = 10;
			...
			iv3.setTag("img_2_" + puzzle_id + "_3");
			iv4.setTag("img_2_" + puzzle_id + "_4");
			iv5.setTag("img_2_" + puzzle_id + "_5");
			iv1.setLayoutParams(imageParams);
			iv2.setLayoutParams(imageParams);
			iv3.setLayoutParams(imageParams);
			iv4.setLayoutParams(imageParams);
			...
			iv6.setBackgroundResource(this.getResources().getIdentifier(
					"img_2_" + puzzle_id + "_6", "drawable", getPackageName()));
			TableRow.LayoutParams imageParams = new TableRow.LayoutParams();
			imageParams.height = width / 3;
			imageParams.width = width / 3 - 15;
			// imageParams.topMargin = 10;
			...
			iv4.setTag("img_2_" + puzzle_id + "_4");
			iv5.setTag("img_2_" + puzzle_id + "_5");
			iv6.setTag("img_2_" + puzzle_id + "_6");
			tr1.addView(iv1);
			tr1.addView(iv2);
			tr1.addView(iv3);
			tr2.addView(iv4);
